      ...
      <div className="space-y-2">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 h-8 px-2 rounded-md border border-border bg-background text-sm focus:outline-none focus:ring-2 focus:ring-ring"
          />
          <input
            type="time"
            value={formatTimeForInput(start)}
            onChange={handleStartTimeChange}
            className="w-[90px] h-8 px-2 rounded-md border border-border bg-background text-sm focus:outline-none focus:ring-2 focus:ring-ring"
          />
        </div>
      </div>
