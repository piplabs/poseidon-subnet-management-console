    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="p-6 space-y-6">
        <div>
          ...
          <p className="text-muted-foreground mt-1">View and manage all workflow executions</p>
        </div>

        <WorkflowTable showViewAll={false} showTitle={false} />

        {/* Pagination */}
        <div className="flex items-center justify-between">
          <p className="text-sm text-muted-foreground">Showing 1-5 of 50 workflows</p>
