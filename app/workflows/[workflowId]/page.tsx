...
const activitiesData = [
  { id: "act-001", name: "Fetch Data", status: "completed", duration: "2m 30s", worker: "worker-001" },
  { id: "act-002", name: "Transform Data", status: "completed", duration: "3m 15s", worker: "worker-002" },
  { id: "act-003", name: "Process Data", status: "running", duration: "1m 45s", worker: "worker-003" },
  // Add more activities as needed
]

const workersData = [
  { id: "worker-001", status: "active", currentActivity: "Fetch Data", tasksCompleted: 2 },
  { id: "worker-002", status: "inactive", currentActivity: "None", tasksCompleted: 1 },
  { id: "worker-003", status: "active", currentActivity: "Process Data", tasksCompleted: 0 },
